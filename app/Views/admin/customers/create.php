...
<div class="max-w-2xl mx-auto px-4 sm:px-0">
    <div class="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100 p-4 sm:p-6 lg:p-8">
        <h2 class="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6">Tambah Pelanggan</h2>

        <form action="<?= base_url('admin/customers/store') ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
