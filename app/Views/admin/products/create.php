...
<div class="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100 overflow-hidden">
    <div class="p-4 sm:p-6 border-b border-slate-100">
        ...
        <p class="text-sm text-slate-500 mt-1">Isi detail produk yang akan ditambahkan</p>
    </div>
    
    <form action="<?= base_url('admin/products/store') ?>" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6">
        <?= csrf_field() ?>
                    ...
                    <div id="dropZone" class="border-2 border-dashed border-slate-200 rounded-xl p-4 sm:p-6 text-center hover:border-primary-400 transition-colors bg-slate-50/50 relative">
                        ...
                        <label for="image" class="cursor-pointer block">
                            <div id="imagePreview" class="hidden mb-4">
                                <img id="preview" src="" alt="Preview" class="max-h-48 sm:max-h-40 mx-auto rounded-lg shadow-lg">
