    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-slate-500 mt-2">Buat akun baru untuk mulai berbelanja</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" 
                                ...
                                <svg id="confirmPasswordToggleIcon" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            </button>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-slate-600">
                    Sudah punya akun? 
                    <a href="<?= base_url('/login') ?>" class="text-primary-600 hover:text-primary-700 font-semibold">Login di sini</a>
                </p>
            </div>
        </div>
    </div>
